...
const CONTRACT_ADDRESSES: Record<number, string> = {
  1: process.env.NEXT_PUBLIC_CONTRACT_ADDRESS_MAINNET || '', // Ethereum Mainnet
  80002: process.env.NEXT_PUBLIC_CONTRACT_ADDRESS_AMOY || '', // Polygon Amoy Testnet
  11155111: process.env.NEXT_PUBLIC_CONTRACT_ADDRESS_SEPOLIA || '', // Sepolia Testnet
  31337: process.env.NEXT_PUBLIC_CONTRACT_ADDRESS_HARDHAT || '0x5FbDB2315678afecb367f032d93F642f64180aa3', // Hardhat Localhost
};
